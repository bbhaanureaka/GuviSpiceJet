...
@CucumberOptions(
        features = {"src/test/resources/features/SpiceJetBooking"},
        monochrome = true,
        tags = "@TEST1",
...
public class DemoWebSpiceJet extends AbstractTestNGCucumberTests {

    @AfterClass
    public void teardown() {
        ExtentService.getInstance().setSystemInfo("Application Name", "SpiceJet Flight Booking Website");
